"""
Test the linear interpolator on the Sawyer(Lift) task environment as a test case.
    ...
    for controller_name in ["EE_POS_ORI", "EE_IK"]:
        ...
        for traj in ["pos", "ori"]:
            ...
            for interpolator in [None, "linear"]:
                ...
                initial_state = [env._right_hand_pos, T.mat2euler(env._right_hand_orn)]
                dstate = [env._right_hand_pos - initial_state[0], T.mat2euler(env._right_hand_orn) - initial_state[1]]
                ...
                while abs(dstate[k][indexes[k]]) < abs(thresholds[k]):
                    ...
                    timesteps[j] += 1
                    dstate = [env._right_hand_pos - initial_state[0],
                              T.mat2euler(env._right_hand_orn) - initial_state[1]]
