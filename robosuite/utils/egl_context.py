...
def create_initialized_egl_device_display(device_id=0):
  ...
  selected_device = os.environ.get('CUDA_VISIBLE_DEVICES', None) if os.environ.get('MUJOCO_EGL_DEVICE_ID', None) is None else os.environ.get('MUJOCO_EGL_DEVICE_ID', None)
