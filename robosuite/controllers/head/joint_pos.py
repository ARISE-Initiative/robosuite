...
from robosuite.controllers.head.head_controller import HeadController
...
class HeadJointPositionController(HeadController):
    """
    Controller for controlling robot head via impedance control. Allows position control of the robot's joints.
