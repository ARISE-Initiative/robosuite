...
from robosuite.controllers.legs.legs_controller import LegsController


class LegsJointTorqueController(LegsController):
    """
    Controller for controlling the robot leg's joint torques. As the actuators at the mujoco sim level are already
    ...
    Args:
        ...
        eef_name (str): Name of controlled robot leg's end effector (from robot XML)
        ...
        torque_limits (2-list of float or 2-list of list of floats): Limits (N-m) below and above which the magnitude
            ...
            If not specified, will automatically set the limits to the actuator limits for this robot leg
