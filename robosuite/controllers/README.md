...
| :-------------: | :-------------------: | :-------------------------------------------------: | :-----: |
| EE_OSC_POSE     |   End-Effector Operational Space Control (Position + Orientation)   | 6 | (x, y, z, i, j, k)    |  
| EE_OSC_POSITION |   End-Effector Operational Space Control (Position Only)            | 3 | (x, y, z)             |  
| EE_IK_POSE      |   End-Effector Inverse Kinematics Control (Position + Orientation)  | 7 | (x, y, z, i, j, k, w) |
