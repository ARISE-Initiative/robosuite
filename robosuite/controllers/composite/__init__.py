...
def composite_controller_factory(type, sim, robot_model, grippers, lite_physics, **kwargs):
    if type == "BASE":
        ...
        return WholeBodyIKCompositeController(sim, robot_model, grippers, lite_physics, **kwargs)
    else:
        raise ValueError
