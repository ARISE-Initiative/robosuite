...
class SawyerClutter(SawyerEnv):
    ...
    def _load_model(self):
        ...
        self.ob_inits = [AnimalObject, BipedObject, GuitarObject, HammerObject, CarObject, TrainObject, DumbbellObject]
        self.item_names = ["Animal", "Biped", "Guitar", "Hammer", "Car", "Train", "Dumbbell"]
        ...
        self.model.place_objects_clutterred()
