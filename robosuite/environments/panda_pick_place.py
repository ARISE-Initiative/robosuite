...
class PandaPickPlaceSingle(PandaPickPlace):
    """
...
class PandaPickPlaceMilk(PandaPickPlace):
    """
...
class PandaPickPlaceCereal(PandaPickPlace):
    """
...
class PandaPickPlaceCan(PandaPickPlace):
    """
