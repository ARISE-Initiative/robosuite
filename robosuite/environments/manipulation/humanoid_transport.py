...
class HumanoidTransport(HumanoidEnv):
    """
    ...
    Args:
        ...
        env_configuration (str): Specifies how to position the robots within the environment. In the case of humanoids should be:

            :`'bimanual'`: Sets up the (single) humanoid robot on the -x side of the table
