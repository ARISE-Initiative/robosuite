...
from robosuite.models.objects import BoxObject, CableObject
from robosuite.models.tasks import ManipulationTask
from robosuite.utils.mjcf_utils import CustomMaterial, new_element
from robosuite.utils.observables import Observable, sensor
from robosuite.utils.placement_samplers import UniformRandomSampler
from robosuite.utils.transform_utils import convert_quat


class CableManipulation(ManipulationEnv):
    """
    This class corresponds to the cable manipulation task for a single robot arm.
    ...
    def reward(self, action=None):
        ...
        # use a shaping reward
            ...
            dist = self._gripper_to_target(
                gripper=self.robots[0].gripper, target=self.cube1.root_body, target_type="body", return_distance=True
            )
    ...
    def _load_model(self):
        ...
        self.cube1 = BoxObject(
            name="cube1",
            size=[0.020, 0.020, 0.020],  # [0.015, 0.015, 0.015],
            rgba=[1, 0, 0, 1],
            material=redwood,
        )
        ...
        self.model.extension.append(new_element("plugin", None, plugin="mujoco.elasticity.cable"))
        self.model.compiler.set("inertiagrouprange", "0 1")
    ...
    def _setup_references(self):
        ...
        self.cube_body_id = self.sim.model.body_name2id(self.cube1.root_body)
