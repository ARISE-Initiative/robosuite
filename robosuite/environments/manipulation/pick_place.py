...
class PickPlace(SingleArmEnv):
    ...
    def __init__(
        ...
        camera_depths=False,
        skill_config=None,
        table_offset=None, # ignore this key
    ):
        # task settings
        self.single_object_mode = single_object_mode
        self.object_to_id = {"can": 0, "bread": 1, "cereal": 2, "milk": 3}
    ...
    def staged_rewards(self):
        ...
        if active_objs and r_grasp > 0.:
            z_target = self.bin2_pos[2] + 0.20 # previously 0.25
    ...
    def _get_placement_initializer(self):
        ...
        bin_x_half = self.model.mujoco_arena.table_full_size[0] / 2 - 0.095 #0.05
        bin_y_half = self.model.mujoco_arena.table_full_size[1] / 2 - 0.095 #0.05
