...
# python robosuite/scripts/collect_human_demonstrations.py --environment Lift --robots GR1FixedLowerBody  --device keyboard --camera frontview --custom-controller-config robosuite/examples/third_party_controller/default_mink_ik_gr1.json
